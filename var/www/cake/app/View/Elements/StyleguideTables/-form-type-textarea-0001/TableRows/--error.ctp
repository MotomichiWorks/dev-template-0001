...
input要素にform-type-text-0001__input-element--errorクラスを付与すると赤くなります。
...
<div class="form-type-textarea-0001">
  <textarea class="form-type-textarea-0001__input-elm form-type-textarea-0001__input-elm--error"></textarea>
</div>
